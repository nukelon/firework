...
// 	document.querySelector('.loading-init').remove();
	...
	// Begin simulation - 初始保持暂停，等待用户点击弹窗按钮后再启动
	togglePause(true);
...
function render(speed) {
	...
	// 核心修改：如果开启了图片背景模式，将原本的“涂黑”改为“擦除透明度”，这样图片才能透出来
	trailsCtx.globalCompositeOperation = window.isImageBackground ? 'destination-out' : 'source-over';
